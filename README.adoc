...
|===
| image::https://sonarcloud.io/api/project_badges/measure?project=studgantfe7623_CarCore&metric=bugs[Bugs] <!--- Hide in GitHub -->
| image::https://sonarcloud.io/api/project_badges/measure?project=studgantfe7623_CarCore&metric=sqale_rating[Maintainability Rating] <!--- Hide in GitHub -->
| image::https://sonarcloud.io/api/project_badges/measure?project=studgantfe7623_CarCore&metric=vulnerabilities[Vulnerabilities] <!--- Hide in GitHub -->
| image::https://sonarcloud.io/api/project_badges/measure?project=studgantfe7623_CarCore&metric=security_rating[Security Rating] <!--- Hide in GitHub -->
| image::https://sonarcloud.io/api/project_badges/measure?project=studgantfe7623_CarCore&metric=coverage[Coverage]
| image::https://sonarcloud.io/api/project_badges/measure?project=studgantfe7623_CarCore&metric=duplicated_lines_density[Duplicated Lines (%)] <!--- Hide in GitHub -->
|===
